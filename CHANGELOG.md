# CHANGELOG
### DONG 2026-07-04
- Browny Shop Review #1 (แก้ไข issue จากการทดสอบ):
 - หน้ารายละเอียดสินค้า: ปรับตัวอักษรที่เล็กเกินไปให้ใหญ่ขึ้น
 - แก้รูปหลักเลื่อนตามตอนกดเลือกตัวเลือกสินค้า (แยกการเลือกตัวเลือกออกจากรูป)
 - แก้รูปแกลเลอรีด้านล่างโดนซูม/ครอป
 - เพิ่ม badge จำนวนสินค้าในตะกร้าบนไอคอนถุง (อัปเดตทันทีหลังเพิ่มของ)
 - แก้กดถูกใจในหน้ารายละเอียดแล้วหน้ารายการไม่อัปเดต — ทำ store กลาง sync ทุกหน้า
- เพิ่มเอกสารสรุป Review BrownyShop #1 (docs/brownyshop/)

### DONG 2026-06-24
- เพิ่มการ fetch browny shop banner
- เพิ่มหน้า "สินค้าที่บันทึกไว้" (Browny Shop Favorites) เข้าได้จากเมนูในหน้า Profile — ดึงสินค้าโปรดจาก API มาแสดงเป็น grid และกดเข้าดูรายละเอียด/เพิ่มลงตะกร้าได้
- หน้าการแจ้งเตือน: ทำให้ปุ่ม toggle (ทั้งหมด / ซัก-อบ / การสั่งซื้อ) กรองรายการตามประเภทได้จริง
