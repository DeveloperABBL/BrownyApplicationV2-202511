...
part 'machine_payment_status_check_response.g.dart';
...
@JsonSerializable()
class MachinePaymentStatusCheckResponse {
  @JsonKey(name: 'status')
  /// สถานะการชำระเงิน
  ...
  factory MachinePaymentStatusCheckResponse.fromJson(
    Map<String, dynamic> json,
  ) => _$MachinePaymentStatusCheckResponseFromJson(json);
  Map<String, dynamic> toJson() =>
      _$MachinePaymentStatusCheckResponseToJson(this);
